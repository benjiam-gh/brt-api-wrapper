...
use Andyts93\BrtApiWrapper\Api\ActualSender;
...
class ReturnRequest extends BaseRequest
{
    ...
    public function toArray()
    {
        return array_filter([
            ...
            'actualSender' => $this->actualSender->toArray()
        ], function ($v) {
            return !is_null($v);
        });
    }
    ...
    /**
     * @param ActualSender $actualSender
     */
    public function setActualSender($actualSender)
    {
    ...
    /**
     * Get the value of returnDepot
     *
     * @return  string
     */ 
    public function getReturnDepot()
    {
        return $this->returnDepot;
    }

    /**
     * Set the value of returnDepot
     *
     * @param  string  $returnDepot
     *
     * @return  self
     */ 
    public function setReturnDepot(string $returnDepot)
    {
